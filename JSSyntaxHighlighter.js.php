...
WebInspector.JavaScriptSourceSyntaxHighlighter = function(table, sourceFrame)
{
    ...
    this.rules = [{
        ...
        pattern: /^(?:"(?:[^"\\]|\\['"\bfnrtv\n]|[^'"\bfnrtv0-9xu\n]|0|x[0-9a-fA-F][0-9a-fA-F]|(?:u[0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F]))*"|'(?:[^'\\]|\\['"\bfnrtv\n]|[^'"\bfnrtv0-9xu\n]|0|x[0-9a-fA-F][0-9a-fA-F]|(?:u[0-9a-fA-F][0-9a-fA-F][0-9a-fA-F][0-9a-fA-F]))*')/,
